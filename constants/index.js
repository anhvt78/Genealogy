...
export const LUKSO_CHAIN_ID = "0x1069";
export const LUKSO_RPC_URL = "https://rpc.testnet.lukso.network";
export const LUKSO_CHAIN_NAME = "LUKSO Testnet";
export const LUKSO_SYMBOL = "LYXt";
