      ...
      {currentIndex !== null && (
        ...
        >
          ...
          <button onClick={prevImage} className="absolute left-4 md:left-10 p-3 rounded-full bg-white/10 hover:bg-white/20 text-white transition-all z-[110]">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="max-w-5xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="order-first md:order-0 space-y-6">
          ...
          <div className="p-6 border-2 border-dashed border-[#5d3a1a]/30 text-[#5d3a1a] italic text-sm flex items-center justify-center gap-1">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "16px", height: "16px" }}>
                <path d="M12 4H7C5.34315 4 4 5.34315 4 7V17C4 18.6569 5.34315 20 7 20H17C18.6569 20 20 18.6569 20 17V12" strokeLinecap="round" stroke="currentColor" strokeWidth="2"></path>
                <path d="M19.9999 8C19.9999 6.17755 20 4 20 4H16" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor" strokeWidth="2"></path>
                <path d="M14 10L20 4" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor" strokeWidth="2"></path>
              </svg>
            </a>
          </div>
        </div>
